...
cp .env.paper-monitor.example .env
```
...
Then open `http://localhost:8000/paper-monitor/`.
...
If your existing site is GitHub Pages, this integration version already publishes the monitor directly from `paper-monitor/`.
