...
from .config import DB_PATH, JOURNAL_LIST_PATH, SYSTEM_ROOT, WEB_JSON_PATH
...
def main() -> None:
    ...
    print("strategy=sciencedirect page->rss->crossref; springer api->online-first->crossref; ieee combined-saved-search-rss->crossref")
    print(f"ieee_combined_rss=1 feed for {len(ieee_specs)} journals")
