...
def main() -> None:
    ...
    print(
        f"Elsevier: Crossref member dual batch (online-date + publication-date fallback, max {CROSSREF_DISCOVERY_DAYS} days) + direct RSS(optional); "
    ...
    print("IEEE: Combined Saved Search RSS primary -> DOI/title Crossref matching -> RSS pubDate fallback when needed")
