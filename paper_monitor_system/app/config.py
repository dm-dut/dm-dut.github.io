...
# Hybrid strategy defaults. Publisher APIs that have repeatedly returned
# permission errors are deliberately disabled by default; their keys may remain
# in GitHub Secrets without being used.
